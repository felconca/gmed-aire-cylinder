<div class="modal-header">
    <div class="h5 modal-title">Types Information</div>
...
<div class="modal-body px-3">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="floatingLocation" placeholder="Location Tags"
            ng-class="{'is-invalid':isInvalid && type_info.tags == ''}"
            ng-model="type_info.tags" ng-disabled="isloading">
        <label for="floatingLocation">Tags <span class="text-danger">*</span></label>
        <small class="invalid-feedback" ng-if="isInvalid && type_info.tags == ''">This field is required</small>
    </div>
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="floatingLocation" placeholder="Location Name"
            ng-class="{'is-invalid':isInvalid && type_info.descriptions == ''}"
            ng-model="type_info.descriptions" ng-disabled="isloading">
        <label for="floatingLocation">Descriptions <span class="text-danger">*</span></label>
        <small class="invalid-feedback" ng-if="isInvalid && type_info.descriptions == ''">This field is required</small>
    </div>
</div>

<div class="modal-footer">
    <button style="padding: 10px 12px;" class="d-flex align-items-center btn btn-light-blue"
        ng-click="saveType(type_info)" ng-disabled="isloading">
        <div ng-if="isloading">
