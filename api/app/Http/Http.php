...
// delivery
Route::group(['prefix' => 'delivery', 'middleware' => [new AuthSession("user")]], function () {
    Route::get('list', 'DeliveryController@index');
    Route::post('add', 'DeliveryController@add');
    Route::get('edit', 'DeliveryController@edit');
    ...
    Route::get('items/list',  'DeliveryController@delivery_items');
    Route::post('items/add',  'DeliveryController@add_items');
    Route::post('items/delete',  'DeliveryController@delete_items');
    Route::get('cylinders',  'DeliveryController@cylinders');
});
